...
function StatCard({
  ...
  return (
    <Link
      href={href}
      className="rounded-2xl border border-sky-200/80 bg-white px-4 py-4 shadow-[0_12px_40px_-28px_rgba(43,92,231,0.45)] transition hover:border-[#2b5ce7]/40"
    >
      ...
      <Card className="border-slate-200/90 bg-white p-5 shadow-sm">
        <label className="flex cursor-pointer items-start gap-3">
          <input
            ...
            className="mt-1 h-4 w-4 shrink-0 rounded border-slate-300 text-[#2b5ce7] focus:ring-[#2b5ce7]"
          />
          <span>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <select className="min-w-[12rem] flex-1 rounded-full border border-slate-200 bg-slate-50/80 px-4 py-2 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#2b5ce7]/30">
                  <option>— choose manager —</option>
                </select>
                <Button type="button" className="rounded-full bg-[#2b5ce7] px-5 shadow-[0_0_18px_rgba(43,92,231,0.35)]">
                  Open
                </Button>
              </div>
