          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <select className="min-w-[12rem] flex-1 rounded-full border border-slate-200 bg-slate-50/80 px-4 py-2 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-primary/30">
                  <option>— choose manager —</option>
                </select>
                <Button type="button" className="rounded-full px-5 shadow-[0_0_18px_rgba(0,122,255,0.28)]">
                  Launch preview
                </Button>
              </div>
