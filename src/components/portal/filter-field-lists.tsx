...
/** Compact filter sheets — grow with fields (up to cap) so sort is never clipped. */
export const PORTAL_FILTER_PANEL_COMPACT_CLASS = `${PORTAL_FILTER_PANEL_WIDTH_CLASS} h-auto max-h-[min(85vh,32rem)]`;
