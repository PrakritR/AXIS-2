    ...
    >
      <div className="rounded-2xl border border-primary/30 bg-primary/5 p-3 text-sm">
        <p className="text-[11px] text-muted">
          Pick a channel and tone — AI drafts ready-to-post copy you can edit before sharing.
        </p>
        <div className="mt-3 space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              data-attr="promotion-text-ai-prompt"
            />
          </div>
          <div className="flex flex-wrap gap-2">
            ...
            <Button type="button" variant="outline" className="h-8 rounded-full px-4 text-xs" onClick={onClose} disabled={busy}>
              Cancel
            </Button>
          </div>
        </div>
