...
function NavDropdown({
  ...
  const scheduleClose = () => { cancelClose(); timer.current = setTimeout(() => setOpen(false), 200); };
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-3">
        ...
        <nav className="hidden items-center lg:flex">
          <NavDropdown label="Rent with Axis" links={RENT_LINKS} active={rentActive} activeHref={activeRentHref} />
          <NavDropdown label="Partner with Axis" links={PARTNER_LINKS} active={partnerActive} activeHref={activePartnerHref} />
        </nav>
