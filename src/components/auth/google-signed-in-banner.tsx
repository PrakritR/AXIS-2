      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 text-left">
            ...
            {subtitle ? <p className="mt-2 text-sm leading-relaxed text-[var(--status-confirmed-fg)]">{subtitle}</p> : null}
          </div>
        </div>
        {onSwitchAccount ? (
          <button
            ...
            className="btn-metallic shrink-0 self-start rounded-full px-4 py-2 text-xs font-semibold text-foreground sm:self-center"
          >
            Switch account
          </button>
        ) : null}
