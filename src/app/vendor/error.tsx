...
export default function VendorPortalError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-2xl border px-5 py-8 text-center text-sm portal-banner-danger shadow-sm">
      <p className="text-lg font-semibold text-rose-950">Vendor portal error</p>
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-2">
        ...
        <Button type="button" variant="outline" className="rounded-full" onClick={() => (window.location.href = "/vendor/dashboard")}>
          Vendor dashboard
        </Button>
      </div>
    </div>
