...
export default function ManagerPortalError({
  ...
  return (
    <div className="mx-auto max-w-lg rounded-2xl border border-rose-200/90 bg-rose-50/90 px-5 py-8 text-center text-sm text-rose-950 shadow-sm">
      <p className="text-lg font-semibold text-rose-950">Manager portal error</p>
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-2">
        ...
        <Button type="button" variant="outline" className="rounded-full" onClick={() => (window.location.href = "/manager/dashboard")}>
          Manager dashboard
        </Button>
      </div>
    </div>
