...
export const MANAGER_PLAN_TIERS: ManagerPlanTierDefinition[] = [
  {
    ...
    features: [
      ...
      { text: "0.5% Axis fee on resident online payments (+ processing)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Applications & tour scheduling", included: true },
      { text: "Payment collection & charges", included: true },
      { text: "0.25% Axis fee on resident online payments (+ processing)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Applications & tour scheduling", included: true },
      { text: "Payment collection & charges", included: true },
      { text: "No Axis fee on resident online payments (+ processing only)", included: true },
      { text: "Residents, leases & work orders", included: true },
