/** SHA-256 hex digest — Web Crypto when available (HTTPS), pure-JS fallback for Capacitor http dev. */
...
/** Sync SHA-256 for environments without crypto.subtle (e.g. iOS WebView on http:// dev). */
