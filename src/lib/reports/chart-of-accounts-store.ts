...
const SYSTEM_CHART_ACCOUNTS_RAW: Omit<ChartAccountRow, "deductible">[] = [
  ...
  { code: "security_deposit_liability", name: "Security Deposits Held", accountType: "liability", accountNumber: 2010, normalBalance: "credit", parentCode: null, isBankAccount: false, isTrustAccount: false, isActive: true, isSystem: true, sortOrder: 10 },
  ...
  { code: "capital_improvement", name: "Capital Improvement", accountType: "expense", accountNumber: 5160, normalBalance: "debit", parentCode: null, isBankAccount: false, isTrustAccount: false, isActive: true, isSystem: true, sortOrder: 130, scheduleERef: "Capitalize (Form 4562)", scheduleELabel: "Capital Improvements" },
];
