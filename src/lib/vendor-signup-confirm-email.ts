...
export const VENDOR_SIGNUP_CONFIRM_SUBJECT = "Confirm your Axis vendor account";
...
export function buildVendorSignupConfirmEmailBody(params: { fullName?: string; confirmLink: string }): string {
  ...
  const lines = [
    greeting,
    "",
    "Confirm your email to finish creating your Axis vendor account.",
    "",
    "Confirm your email:",
    params.confirmLink,
    "",
...
<p style="margin:0 0 16px 0">Confirm your email to finish creating your Axis vendor account.</p>
...
<p style="margin:8px 0 0 0;color:#64748b;font-size:14px">— Axis</p>
</div>
</body>
</html>`;
}
