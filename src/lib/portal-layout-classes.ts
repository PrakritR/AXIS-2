...
/** Mobile portal top chrome (section nav) — safe-area top when no banner sits above. */
...
export const PORTAL_MAIN_CONTENT_INNER_CLASS =
  "portal-main-inner flex min-h-full w-full flex-1 flex-col justify-center lg:min-h-0 lg:flex-initial lg:justify-start";
