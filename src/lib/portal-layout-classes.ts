...
/** Mobile: vertically center tab content in the viewport; desktop: pass-through wrapper. */
export const PORTAL_MAIN_CONTENT_INNER_CLASS =
  "portal-main-inner flex min-h-full w-full flex-1 flex-col justify-center lg:contents";
