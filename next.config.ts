...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      { source: "/admin/calendar", destination: "/admin/events/events", permanent: false },
      { source: "/admin/calendar/week", destination: "/admin/events/events", permanent: false },
      { source: "/admin/calendar/availability", destination: "/admin/events/availability", permanent: false },
